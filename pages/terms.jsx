...
const terms = () => {
  return (
    <Layout title="Terms and Condition">
      ...
      <p>Welcome to hollywoodfashionsale!</p>
      <p>
        These terms and conditions outline the rules and regulations for the use
        of Hollywood Fashion Sale&apos;s Website, located at
        https://hollywoodfashionsale.com.
      </p>
      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use hollywoodfashionsale if you do not
      ...
      <p>
        We employ the use of cookies. By accessing hollywoodfashionsale, you
        agreed to use cookies in agreement with the Hollywood Fashion
        Sale&apos;s Privacy Policy.{" "}
      </p>
      <p>
      ...
      <p>
        Unless otherwise stated, Hollywood Fashion Sale and/or its licensors own
        the intellectual property rights for all material on
        hollywoodfashionsale. All intellectual property rights are reserved. You
        may access this from hollywoodfashionsale for your own personal use
        subjected to restrictions set in these terms and conditions.
      </p>
      <p>You must not:</p>
      <ul>
        <li>Republish material from hollywoodfashionsale</li>
        <li>Sell, rent or sub-license material from hollywoodfashionsale</li>
        <li>Reproduce, duplicate or copy material from hollywoodfashionsale</li>
        <li>Redistribute content from hollywoodfashionsale</li>
      </ul>
      <p>
      ...
      <p>
        ...
        Hollywood Fashion Sale does not filter, edit, publish or review Comments
        prior to their presence on the website. Comments do not reflect the
        views and opinions of Hollywood Fashion Sale,its agents and/or
        ...
        laws, Hollywood Fashion Sale shall not be liable for the Comments or for
      ...
      <p>
        Hollywood Fashion Sale reserves the right to monitor all Comments and to
      ...
      <p>
        You hereby grant Hollywood Fashion Sale a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Hollywood Fashion Sale; and (d)
      ...
      <p>
        ...
        e-mail to Hollywood Fashion Sale. Please include your name, your
      ...
      <p>
        No use of Hollywood Fashion Sales logo or other artwork will be allowed
